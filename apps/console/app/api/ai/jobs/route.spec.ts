...
jest.mock('../../../../../../libs/tenant/data/admin/src/lib/server/id-token-refusal', () => ({
  __esModule: true,
...
jest.mock('../../../../../../libs/tenant/data/admin/src/lib/server/api-http', () => ({
  __esModule: true,
  checkRateLimit: () => ({ allowed: mockRateAllowed, limit: 10, remaining: 9, resetAt: 0 }),
  rateLimitHeaders: () => ({ 'X-RateLimit-Limit': '10' }),
}))
jest.mock('../../../../../../libs/tenant/data/admin/src/lib/server/ai-runtime', () => ({
  __esModule: true,
  ...jest.requireActual(
    '../../../../../../libs/tenant/data/admin/src/lib/server/ai-runtime',
  ),
