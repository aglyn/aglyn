...
// lockdown-423: via libs/tenant/data/admin/src/lib/server/ai-gate.ts
// The POST climbs `aiGateLadder`, whose lockdown rung is the verdict; the
// GET climbs `_lib/ai-jobs-gate.ts`, which carries the same rung.
...
import { aiGateLadder } from '@aglyn/tenant-data-admin/server/ai-gate'
import { AI_JOB_BRIEF_MAX_CHARS } from '@aglyn/tenant-data-admin/server/ai-job-text-step'
import {
  ...
  listAiJobs,
  runAiJobStep,
} from '@aglyn/tenant-data-admin/server/ai-jobs'
import { releaseAssistMessage } from '@aglyn/tenant-data-admin/server/assist-usage'
import { aiJobsGate } from '../../_lib/ai-jobs-gate'
