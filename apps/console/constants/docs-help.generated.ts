...
export const DOCS_HELP_ANCHORS = {
  ...
  sso: ['#setting-it-up', '#1-verify-your-domain', '#2-connect-your-identity-provider', '#rotating-your-signing-certificate', '#3-turn-it-on', '#how-it-works', '#enforcement', '#you-must-designate-a-break-glass-account-first', '#consequences-worth-knowing-before-you-switch', '#testing-it', '#related'],
