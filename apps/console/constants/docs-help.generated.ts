...
export const DOCS_HELP_ANCHORS = {
  ...
  billing: ['#tiers--entitlements', '#usage-meters', '#seats', '#audience-contacts', '#organization-data', '#api-access', '#payments', '#platform-fees', '#related'],
  ...
  components: ['#promote', '#insert-instances', '#manage', '#used-by', '#tips', '#related'],
  ...
  publisherHandbook: ['#before-your-first-publish', '#the-publisher-agreement', '#where-to-publish-from', '#what-installing-each-type-does', '#publishing-a-version', '#before-you-publish', '#review-what-happens-after-you-publish', '#testing-a-version-before-it-is-approved', '#watching-your-own-submission', '#private-plugins', '#authoring-your-listing', '#versioning--updates', '#shipping-a-new-version', '#how-installs-work-the-buyer-side', '#getting-paid'],
  ...
  team: ['#team-roles', '#organizations', '#what-a-site-collaborator-sees', '#site-membership', '#seats', '#related'],
