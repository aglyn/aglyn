...
export const DOCS_HELP_ANCHORS = {
  ...
  lockdown: ['#what-a-lockdown-does', '#reasons-and-the-notice', '#maintenance-windows-and-expiry', '#who-keeps-access-the-un-panic-invariant', '#feature-scope', '#operating-it', '#what-the-audit-row-records'],
