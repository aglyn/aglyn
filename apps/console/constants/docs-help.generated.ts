...
export const DOCS_HELP_TOPICS = {
  ...
  activities: {
    ...
    excerpt: 'Log calls, emails, meetings and notes against a contact, a company or a deal, and read them in one timeline beside everything the platform captured and every campaign it sent.',
  },
  addALocale: {
...
export const DOCS_HELP_ANCHORS = {
  ...
  activities: ['#three-kinds-of-history', '#campaign-email', '#logging-an-activity', '#where-an-activity-is-visible', '#the-recent-activity-feed', '#related'],
  ...
  automations: ['#the-events', '#the-steps', '#assigning-an-owner-or-rotating-one', '#example-tag-every-new-contact-from-a-form', '#example-spread-qualified-leads-across-the-team', '#example-follow-up-on-a-won-deal', '#related'],
  ...
  tasks: ['#the-tasks-page', '#snoozing-a-task', '#creating-a-task', '#assigning-a-task-to-someone-else', '#completing-and-reopening', '#tasks-on-a-contact-company-or-deal', '#the-daily-digest', '#turning-it-off', '#the-dashboard-card', '#who-can-do-what', '#related'],
