...
export const DOCS_HELP_ANCHORS = {
  ...
  forms: ['#build-a-form', '#monthly-allowance-per-plan', '#spam-and-abuse-protection', '#the-per-site-monthly-ceiling', '#field-types', '#labels-and-placeholders', '#example-a-quick-survey', '#after-submit', '#example-grow-an-email-list-from-a-signup-form', '#where-submissions-go', '#the-inbox', '#related'],
  ...
  troubleshooting: ['#checklist', '#verified-but-not-serving', '#still-stuck', '#related'],
