...
export const DOCS_HELP_ANCHORS = {
  ...
  forms: ['#build-a-form', '#monthly-allowance-per-plan', '#field-types', '#labels-and-placeholders', '#example-a-quick-survey', '#after-submit', '#example-grow-an-email-list-from-a-signup-form', '#where-submissions-go', '#the-inbox', '#related'],
