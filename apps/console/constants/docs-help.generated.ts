...
export const DOCS_HELP_ANCHORS = {
  ...
  billing: ['#tiers--entitlements', '#enterprise', '#single-sign-on-and-enforcement', '#usage-meters', '#storage-overage', '#if-you-would-rather-uploads-stopped', '#seats', '#audience-contacts', '#organization-data', '#api-access', '#payments', '#sales-tax', '#platform-fees', '#related'],
