...
export const DOCS_HELP_ANCHORS = {
  ...
  automations: ['#the-events', '#the-steps', '#assigning-an-owner-or-rotating-one', '#recipes', '#example-tag-every-new-contact-from-a-form', '#example-spread-qualified-leads-across-the-team', '#example-follow-up-on-a-won-deal', '#related'],
