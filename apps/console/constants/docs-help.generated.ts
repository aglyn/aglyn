...
export const DOCS_HELP_ANCHORS = {
  ...
  inviteTeammates: ['#invite-someone', '#pending-invites', '#accepting-an-invite', '#how-team-members-act', '#help-a-teammate-who-is-locked-out', '#why-you-cant-always-set-a-password', '#activity-log', '#tips', '#related'],
  ...
  media: ['#organize', '#upload', '#deliver-over-cdn', '#urls-are-stable', '#who-an-asset-is-shared-with', '#components', '#related'],
