...
export const DOCS_HELP_ANCHORS = {
  ...
  buildABlog: ['#1-create-a-collection', '#2-write-entries', '#scheduling', '#categories', '#visual-editor', '#3-design-the-pages-with-template-screens', '#blog-blocks', '#entry-tokens', '#no-template-still-designed', '#paginated-page-sets', '#4-publish--syndicate', '#tips', '#related'],
  ...
  components: ['#promote', '#insert-instances', '#properties', '#declare-them', '#use-them', '#save-then-publish', '#fill-them-in-per-page', '#what-an-instance-can--and-cant--restyle', '#retrofit-duplicated-sections', '#detach', '#nesting', '#used-by', '#manage', '#copy--paste-vs-reusable-components', '#tips', '#related'],
  ...
  forms: ['#build-a-form', '#monthly-allowance-per-plan', '#field-types', '#example-a-quick-survey', '#after-submit', '#example-grow-an-email-list-from-a-signup-form', '#where-submissions-go', '#the-inbox', '#related'],
