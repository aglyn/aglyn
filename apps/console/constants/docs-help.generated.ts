...
export const DOCS_HELP_ANCHORS = {
  ...
  lockdown: ['#what-a-lockdown-does', '#reasons-and-the-notice', '#read-only-mode', '#maintenance-windows-and-expiry', '#who-keeps-access-the-un-panic-invariant', '#feature-scope', '#asset-quarantine--one-file-not-the-site-that-serves-it', '#operating-it', '#never-take-a-lock-or-a-lift-on-trust', '#what-a-caller-is-told', '#verifying-a-lockdown-on-the-wire', '#what-the-audit-row-records'],
