...
export const DOCS_HELP_ANCHORS = {
  ...
  billing: ['#tiers--entitlements', '#enterprise', '#single-sign-on-and-enforcement', '#usage-meters', '#storage-overage', '#if-you-would-rather-uploads-stopped', '#usage-budget', '#seats', '#audience-contacts', '#organization-data', '#api-access', '#payments', '#billing-email', '#payment-methods', '#billing-address', '#tax-ids', '#sales-tax', '#platform-fees', '#related'],
  ...
  elementCatalog: ['#finding-an-element', '#element-search', '#element-detail', '#layout', '#grid', '#surface', '#accordion', '#navigation', '#tabs', '#tabs-that-go-to-another-screen', '#pagination', '#text', '#data-display', '#media', '#image-list', '#forms-input-commerce-members', '#related'],
  ...
  plugins: ['#install--upgrade', '#browse-card', '#whats-included', '#what-the-badges-on-a-listing-mean', '#how-plugins-run', '#when-one-plugin-depends-on-another', '#configure', '#configure-site', '#publish-your-own', '#related'],
  ...
  salesTaxReturn: ['#choosing-the-period', '#rows-that-need-attention', '#where-this-deployment-files', '#tax-filing-precedence', '#tax-filing-secrecy', '#the-figures', '#refunds', '#aglyns-own-sales-by-jurisdiction', '#facilitated-sales-by-buyer-state', '#exporting-the-working-papers', '#related'],
