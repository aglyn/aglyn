...
export const DOCS_HELP_EXCERPTS = {
  ...
  aiMonitoring: 'How staff watch one organization\'s AI usage — the add-on, the credit pool, overage and refusals, generation jobs, the people spending the most, the margin — and where those figures appear across the staff console.',
