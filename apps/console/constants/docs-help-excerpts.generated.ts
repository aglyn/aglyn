...
export const DOCS_HELP_EXCERPTS = {
  ...
  ai: 'What Aglyn AI is, what it can build, how credits and caps work in shape, and the rule that every generation lands as a draft nobody has published.',
  ...
  copyAssist: 'Rewrite any text on the canvas, or write it from nothing, without leaving the Besigner — as an unsaved change you can undo.',
  ...
  generateASite: 'Describe a business and an Aglyn AI build job plans a small site — its pages, navigation, layout, contact form and palette — then builds each page as a draft. An agency can run one brief across many sites at once.',
  ...
  outreach: 'One-to-one email sequences a rep sends to a person from their own connected mailbox, kept with the CRM. Rolling out.',
