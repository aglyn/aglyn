...
export const DOCS_HELP_EXCERPTS = {
  ...
  acquisition: 'Where an account or workspace came from: its first visit, the door it signed up through, and whether the sales workspace already knew the person — recorded once at creation, read from one card.',
