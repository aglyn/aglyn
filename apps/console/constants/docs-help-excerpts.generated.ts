...
export const DOCS_HELP_EXCERPTS = {
  ...
  seoByAi: 'AI SEO for websites, on the pages you already have: have AI write a page or product\'s search listing, audit every published page with a proposed fix for each finding, and draft your structured data and /llms.txt.',
