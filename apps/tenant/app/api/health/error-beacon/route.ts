 ...
 * in `apps/console` is the other half.
 *
...
// The tenant half: this deployment's admin credential is a different one from
// the console's, so both need their own heartbeat.
