...
import { resolveScreenRoutes } from './resolve-screen-routes'
...
export default async function CatchAllPage({ params }: CatchAllPageProps) {
  ...
  // one publishing wrote (AGL-1998) — the whole reasoning lives with the
  // helper, which the live-site preview route shares (AGL-3205). Read off
  // `result.props` rather than the pruned copy: the links a withheld lazy
  // panel holds are still this page's.
