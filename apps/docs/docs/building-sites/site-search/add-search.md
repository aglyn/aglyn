...
Adding search is a matter of placing one element. The [search page and
matcher](overview.md) are built in.
...
That's the whole setup — there's no search setting to switch on and no index to
build.
...
- [Site search overview](overview.md)
