...
import type { AglynElementsDenormalized, ElementsDataStoreApi } from '@aglyn/foundation-data-core'
...
export type CanvasElementWithApi = [elements: AglynElementsDenormalized, api: ElementsDataStoreApi]
