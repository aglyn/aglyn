...
export function useAglynElementData<P>($id: ElementId): AglynElementDenormalized<P>
export function useAglynElementData<P, K extends keyof AglynElementDenormalized<P> = null>(
  $id: ElementId,
  property: K
): AglynElementDenormalized<P>[K]
export function useAglynElementData<P, K extends keyof AglynElementDenormalized<P> = null>(
