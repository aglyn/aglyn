...
import type { AglynComponentSchema, ElementId } from '@aglyn/foundation-data-core'
import useAglynComponentSchema from './use-aglyn-component-schema'
import useAglynElementData from './use-aglyn-element-data'

export function useAglynElementComponentSchema($id: ElementId): AglynComponentSchema {
