...
import { type ElementId, isRootElementId, moveCanvasElement } from '@aglyn/foundation-data-core'
...
export const MoveButtons = forwardRef<any, { $id: ElementId }>(function RefRenderFn(props, ref) {
  const { $id } = props
