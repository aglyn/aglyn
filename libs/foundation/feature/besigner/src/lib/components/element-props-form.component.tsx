...
import { type ElementId, updateCanvasElement } from '@aglyn/foundation-data-core'
import { useAglynAppContext, useAglynElementData } from '@aglyn/foundation-feature-renderer'
import {
  FormRenderer,
...
const ElementPropsForm = forwardRef<any, ElementPropsFormProps>(function RefRenderFn(props, ref) {
  const { $id, ...rest } = props
      ...
      <NoSsr>
        ...
        >
          {({ formFields, schema, ...rest }) => (
            <>
              <ElementPropsFormTemplate formFields={formFields} schema={schema} {...rest} />
