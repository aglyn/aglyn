...
const PanelControlsComponent = forwardRef<any, PanelControlsProps>(function RefRenderFn(
  props,
  ref
) {
  ...
  const openPanels = [panelLeft, panelRight].filter((i) => Boolean(i?.toggled)).map((i) => i?.id)
