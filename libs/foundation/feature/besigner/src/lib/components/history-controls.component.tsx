...
const HistoryControlsComponent = forwardRef<any, HistoryControlsProps>(function RefRenderFn(
  props,
  ref
) {
  ...
  return (
    <MuiStack ref={ref} direction="row" spacing={0.25} {...props}>
      <MuiTooltip title={'Undo (⌘Z)'}>
        <span>
          <MuiIconButton aria-label="undo action" onClick={undo} disabled={!canUndo}>
      ...
      <MuiTooltip title={'Redo (⌘Y)'}>
        <span>
          <MuiIconButton aria-label="redo action" onClick={redo} disabled={!canRedo}>
