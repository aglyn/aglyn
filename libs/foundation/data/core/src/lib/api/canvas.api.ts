...
export function getCanvasStore(app: IAglynAppController, payload?: CanvasGetStorePayload) {
...
export function getCanvasApiEvents(app: IAglynAppController, payload?: CanvasGetApiEventsPayload) {
  const canvasController = _getCanvasController(app)
  return canvasController.getApi(payload)
}

export function canvasUndo(app: IAglynAppController, payload: CanvasUndoPayload) {
  const canvasController = _getCanvasController(app)
  return canvasController.undo(payload)
}

export function canvasRedo(app: IAglynAppController, payload: CanvasRedoPayload) {
  const canvasController = _getCanvasController(app)
  return canvasController.redo(payload)
}

export function setCanvasElements(app: IAglynAppController, payload: CanvasSetElementsPayload) {
  const canvasController = _getCanvasController(app)
  return canvasController.setElements(payload)
}

export function addCanvasElement(app: IAglynAppController, payload: CanvasAddElementPayload) {
  const canvasController = _getCanvasController(app)
  return canvasController.addElement(payload)
}

export function updateCanvasElement(app: IAglynAppController, payload: CanvasUpdateElementPayload) {
  const canvasController = _getCanvasController(app)
  return canvasController.updateElement(payload)
}

export function setCanvasElement(app: IAglynAppController, payload: CanvasSetElementPayload) {
  const canvasController = _getCanvasController(app)
  return canvasController.setElement(payload)
}

export function deleteCanvasElement(app: IAglynAppController, payload: CanvasDeleteElementPayload) {
  const canvasController = _getCanvasController(app)
  return canvasController.deleteElement(payload)
}

export function moveCanvasElement(app: IAglynAppController, payload: CanvasMoveElementPayload) {
  const canvasController = _getCanvasController(app)
