 ...
 */
export function setUserLogHandler(app: IAglynAppController, logHandler: LogHandler): void
/**
 * Sets log handler for all SDKs components
 ...
 */
export function setLogLevel(app: IAglynAppController, options: { logLevel: LogLevelString }): void
