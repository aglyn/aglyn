  ...
  implements IAglynExtensionsController
{
  ...
  public registerExtension(payload: ExtensionRegisterPayload): this {
    ...
    if (extensionName && isAglynExtension(extension)) {
      ...
      this.handleEvent(
        [AglynEventStateFlag.EXTENSION_REGISTERING, AglynEventStateFlag.EXTENSION_REGISTERED],
        { namespace },
        () => {
  ...
  public initializeExtension(payload: ExtensionInitializePayload): this {
    ...
    if (extensionName && isAglynExtension(extension)) {
      ...
      const namespace = extension?.namespace
      this.handleEvent(
        [AglynEventStateFlag.EXTENSION_INITIALIZING, AglynEventStateFlag.EXTENSION_INITIALIZED],
        { namespace },
        () => {
  ...
  public activateExtension(payload: ExtensionLoadPayload): this {
    ...
    if (
      extension &&
      (lifecycle === AglynLifecycleFlag.INITIALIZED || lifecycle === AglynLifecycleFlag.DEACTIVATED)
    ) {
      extension.lifecycle = AglynLifecycleFlag.ACTIVATING
      const namespace = extension?.namespace
      this.handleEvent(
        [AglynEventStateFlag.EXTENSION_ACTIVATING, AglynEventStateFlag.EXTENSION_ACTIVATED],
        { namespace },
        () => {
  ...
  public deactivateExtension(payload: ExtensionUnloadPayload): this {
    ...
    if (extension) {
      ...
      const namespace = extension?.namespace
      this.handleEvent(
        [AglynEventStateFlag.EXTENSION_DEACTIVATING, AglynEventStateFlag.EXTENSION_DEACTIVATED],
        { namespace },
        () => {
  ...
  public destroyExtension(payload: ExtensionDestroyPayload): this {
    ...
    if (extension) {
      ...
      const namespace = extension?.namespace
      this.handleEvent(
        [AglynEventStateFlag.EXTENSION_DESTROYING, AglynEventStateFlag.EXTENSION_DESTROYED],
        { namespace },
        () => {
