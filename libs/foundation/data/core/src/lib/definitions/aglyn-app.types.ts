...
export interface IAglynAppController<Options extends AglynAppOptions = AglynAppOptions>
  extends IAglynBaseModel<Options> {
...
export interface AglynAppControllerT<Options extends AglynAppOptions = AglynAppOptions>
  extends AglynBaseModelT<Options> {
  readonly platform: AglynPlatform
  readonly version: AglynVersion
