...
/**
 * What one EMAIL console load actually READS (AGL-693).
 *
...
describe('emails console read cost (AGL-693)', () => {
  afterEach(() => {
    mockSection = ''
    mockListens.length = 0
  })
   ...
   * difference is billable: rendering 'campaigns' here would pay for its
  ...
  it('the sectionless URL redirects and reads nothing', async () => {
    ...
    expect(mockReplace).toHaveBeenCalledWith(`${BASE_PATH}/campaigns`)
  })
