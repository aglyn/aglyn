 ...
 * can read anyway. The two columns the import has no field for — sources
 * and the last interaction — are still written, because they are what a
 * merchant reads the file for; they map to "Do not import" on the way back.
 */
