...
describe('the contacts CSV', () => {
  ...
  it('joins multi-valued cells with |, names the owner by address, and quotes what needs quoting', () => {
    ...
    expect(csv.split('\n')).toEqual([
      ...
      'a@example.com,"Ada, Countess",+15125550100,CTO,Acme,owner@example.com,Sales qualified,1 Main St,,Austin,TX,78701,US,vip|wholesale,form|order,2026-01-02T00:00:00.000Z,"Said ""hello""",gold,yes',
