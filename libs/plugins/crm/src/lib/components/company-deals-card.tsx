...
/**
 * The deals filed against one company (AGL-2597).
 *
 * A card in a file of its own so the Deals section can replace it with the
 * real list — `orgs/{orgId}/deals` where `companyId` is this one — without
 * touching the page that mounts it. Until then it holds the place and reads
 * nothing.
 */
