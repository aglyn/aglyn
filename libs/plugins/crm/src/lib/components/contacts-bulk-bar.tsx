...
type PendingAction = 'add-tag' | 'remove-tag' | 'owner' | 'stage'
...
function ContactsBulkBarBody(props: ContactsBulkBarProps) {
  const { hostId, scope, consentGroup, rows, selected, onSelectedChange } = props
  ...
  }, [pending, scope, consentGroup.groupId, value, selectedRows, apply])
