 ...
 * effect both cards grew in AGL-1716; a `() => ({})` stub hands back a new
...
jest.mock('firebase/firestore', () => ({
  ...
  // Both cards read their cap as a server aggregate (AGL-1716). The real
  // one throws SYNCHRONOUSLY on the stubbed ref above, which crashes the
  // render before the AGL-1358 guard can be exercised at all. Answering
  // with the fixture's own length keeps the cap arithmetic true on both the
  // pending fallback and the resolved read.
