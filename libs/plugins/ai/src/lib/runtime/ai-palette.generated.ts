...
export const AI_PALETTE: Record<string, AiPaletteEntry> = {
  ...
  emailSection: {
    ...
    presets: ['Email section', 'Header', 'Footer'],
  },
  emailSpacer: {
    pluginId: 'email',
    kind: 'element',
