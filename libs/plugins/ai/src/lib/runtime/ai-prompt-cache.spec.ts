...
describe('the ledger: what each request caches, against its model’s minimum', () => {
  ...
  it('holds every request’s cached span to a measured size', () => {
    ...
    expect(measured()).toEqual({
      plan: { prefixTokens: 2_825, minimum: 1_024, caches: true, toolsStable: true },
      layout: { prefixTokens: 4_310, minimum: 1_024, caches: true, toolsStable: true },
      template: { prefixTokens: 4_883, minimum: 1_024, caches: true, toolsStable: true },
      component: { prefixTokens: 4_838, minimum: 1_024, caches: true, toolsStable: true },
      email: { prefixTokens: 2_797, minimum: 1_024, caches: true, toolsStable: true },
      form: { prefixTokens: 2_425, minimum: 1_024, caches: true, toolsStable: true },
      'page-section': { prefixTokens: 4_392, minimum: 1_024, caches: true, toolsStable: true },
      theme: { prefixTokens: 3_222, minimum: 1_024, caches: true, toolsStable: true },
      ...
      'eval-grade': { prefixTokens: 1_698, minimum: 1_024, caches: true, toolsStable: true },
