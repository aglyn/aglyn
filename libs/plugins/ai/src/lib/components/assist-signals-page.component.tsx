...
export function AssistSignalsPage(_props: ConsoleStaffPageProps) {
  ...
  return (
    <Stack spacing={3}>
      ...
      <CardDisplay
        header={'Fleet'}
        help={pluginDocsHelp('assistSignals', { anchor: '#fleet' })}
        contentGutterX
        contentGutterY
      >
        {!totals ? (
      ...
      <CardDisplay
        ...
        help={pluginDocsHelp('aiMonitoring', { anchor: '#the-spend-leaderboard' })}
        contentGutterX
        contentGutterY
      >
        {spend?.failed ? (
      ...
      <CardDisplay
        ...
        help={pluginDocsHelp('assistSignals', { anchor: '#where-the-money-goes' })}
        contentGutterX
        contentGutterY
      >
      ...
      <CardDisplay
        header={'Docs gaps'}
        help={pluginDocsHelp('assistSignals', { anchor: '#docs-gaps' })}
        contentGutterX
        contentGutterY
      >
        <Typography variant="body2" color="text.secondary" gutterBottom>
      ...
      <CardDisplay
        ...
        help={pluginDocsHelp('assistSignals', { anchor: '#questions-the-docs-could-not-answer' })}
        contentGutterX
        contentGutterY
      >
        <Typography variant="body2" color="text.secondary" gutterBottom>
      ...
      <CardDisplay
        ...
        help={pluginDocsHelp('assistSignals', { anchor: '#what-people-actually-asked' })}
        contentGutterX
        contentGutterY
      >
        <Typography variant="body2" color="text.secondary" gutterBottom>
      ...
      <CardDisplay
        ...
        help={pluginDocsHelp('assistSignals', { anchor: '#what-assist-costs-by-workspace' })}
        contentGutterX
        contentGutterY
      >
        <Typography variant="body2" color="text.secondary" gutterBottom>
