...
const FieldIconSelect = forwardRef<any, Props & WithStyles<typeof styles>>(function RefRenderFn(
  props,
  ref,
) {
  const {
...
export default withGridItem(withStyles(styles, {name: 'FieldIconSelect'})(FieldIconSelect))
