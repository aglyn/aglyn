...
export type IconKeys = Normal.KeysFromList<Json['iconIds']> | keyof Json['byIconId']
export type Icon = Normal.Values<Json['byIconId']>
export type Icons = {
