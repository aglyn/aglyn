...
export const PLUGIN_DOCS_ANCHORS = {
  ...
  outreach: ['#what-it-is-for', '#sent-from-your-own-mailbox', '#where-it-lives', '#compliance-settings', '#allowed-countries', '#sequences', '#build-a-sequence', '#sequence-status', '#enroll', '#cold-contacts', '#enrollments', '#related'],
