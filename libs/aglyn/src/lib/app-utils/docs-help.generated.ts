...
export const PLUGIN_DOCS_ANCHORS = {
  ...
  crmTasks: ['#the-tasks-page', '#selecting-exporting-and-acting-on-many', '#creating-a-task', '#assigning-a-task-to-someone-else', '#completing-and-reopening', '#tasks-on-a-contact-company-or-deal', '#the-dashboard-card', '#who-can-do-what', '#related'],
