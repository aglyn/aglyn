...
export const PLUGIN_DOCS_ANCHORS = {
  ...
  contactActivities: ['#four-kinds-of-history', '#campaign-email', '#logging-an-activity', '#click-to-call', '#sending-an-email', '#delivery-states', '#where-an-activity-is-visible', '#the-recent-activity-feed', '#related'],
  ...
  crmTasks: ['#the-tasks-page', '#snoozing-a-task', '#selecting-exporting-and-acting-on-many', '#creating-a-task', '#assigning-a-task-to-someone-else', '#completing-and-reopening', '#organization-tasks', '#tasks-on-a-contact-company-or-deal', '#next-activity', '#the-daily-digest', '#turning-it-off', '#the-dashboard-card', '#who-can-do-what', '#related'],
