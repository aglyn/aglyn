...
export const PLUGIN_DOCS_ANCHORS = {
  ...
  contactActivities: ['#four-kinds-of-history', '#campaign-email', '#logging-an-activity', '#sending-an-email', '#delivery-states', '#captured-email', '#where-an-activity-is-visible', '#the-recent-activity-feed', '#related'],
  ...
  crmSettings: ['#companies', '#create-companies-from-work-email-domains', '#default-owner', '#assignment-rules', '#round-robin', '#email-capture', '#recipes', '#related'],
