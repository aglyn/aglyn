...
[Compare with the previous release](https://github.com/aglyn/aglyn/compare/v1.0.0-beta.171...v1.0.0-beta.172)
...
- **crm:** the host-path lead fallback is removed ([AGL-3277](https://linear.app/aglyn/issue/AGL-3277), [AGL-3275](https://linear.app/aglyn/issue/AGL-3275), [AGL-3276](https://linear.app/aglyn/issue/AGL-3276))
...
- **tenant:** a post is dated in its publisher's zone, not the server's ([AGL-3237](https://linear.app/aglyn/issue/AGL-3237), [AGL-1926](https://linear.app/aglyn/issue/AGL-1926), [AGL-1361](https://linear.app/aglyn/issue/AGL-1361))
...
- **console:** name the records band for what the plan has ([AGL-2851](https://linear.app/aglyn/issue/AGL-2851))
- **rules:** refuse every CRM client write on a plan without the CRM ([AGL-2851](https://linear.app/aglyn/issue/AGL-2851))
- **console:** export and erase a workspace's people from Settings, on every plan ([AGL-2839](https://linear.app/aglyn/issue/AGL-2839), [AGL-2851](https://linear.app/aglyn/issue/AGL-2851))
- **api:** refuse /v1 contacts on a plan without the CRM ([AGL-2851](https://linear.app/aglyn/issue/AGL-2851))
- **console:** lock the whole CRM on a plan without it, beside the shell's notice ([AGL-2851](https://linear.app/aglyn/issue/AGL-2851))
- **crm:** refuse every crm/* read and write on a plan without the CRM ([AGL-2851](https://linear.app/aglyn/issue/AGL-2851))
- **tools:** check a push in seconds for the classes that most often reached main ([AGL-2837](https://linear.app/aglyn/issue/AGL-2837))
- **media:** pause tenant video uploads behind release_video_uploads ([AGL-2830](https://linear.app/aglyn/issue/AGL-2830), [AGL-2832](https://linear.app/aglyn/issue/AGL-2832))
- **crm:** open the CRM on read-only Leads and lock Contacts without the suite ([AGL-2790](https://linear.app/aglyn/issue/AGL-2790))
- **crm:** refuse every contact edit on a plan without the CRM suite ([AGL-2790](https://linear.app/aglyn/issue/AGL-2790))
- **video:** play a Wistia film behind a click-to-play poster ([AGL-2826](https://linear.app/aglyn/issue/AGL-2826))
- **tenant:** file a lead from every live form on a plan without the CRM suite ([AGL-2790](https://linear.app/aglyn/issue/AGL-2790))
- **video:** own player controls in the lightbox, so Escape closes it from every stop ([AGL-2802](https://linear.app/aglyn/issue/AGL-2802))
- **besigner:** a Screen Link can target a content collection's listing page ([AGL-2799](https://linear.app/aglyn/issue/AGL-2799), [AGL-1893](https://linear.app/aglyn/issue/AGL-1893))
- **crm:** open the CRM to every workspace and name its flag release_crm ([AGL-2772](https://linear.app/aglyn/issue/AGL-2772))
- **marketing:** the Datasets product deck, with job openings as its sample data ([AGL-2769](https://linear.app/aglyn/issue/AGL-2769))
- **monitoring:** dispatch the canary from a GitHub App, not an expiring PAT ([AGL-2758](https://linear.app/aglyn/issue/AGL-2758))
- **dam:** let replace swap a PDF, a film or a document, not only an image ([AGL-2732](https://linear.app/aglyn/issue/AGL-2732), [AGL-184](https://linear.app/aglyn/issue/AGL-184), [AGL-2742](https://linear.app/aglyn/issue/AGL-2742))
- **monitoring:** run the edge sampler in GCP, with no stored credential ([AGL-2758](https://linear.app/aglyn/issue/AGL-2758))
- **video:** serve the renditions the producer makes, by asking for them ([AGL-2753](https://linear.app/aglyn/issue/AGL-2753), [AGL-2745](https://linear.app/aglyn/issue/AGL-2745), [AGL-2743](https://linear.app/aglyn/issue/AGL-2743), [AGL-1515](https://linear.app/aglyn/issue/AGL-1515))
- **release:** tag a release that shipped without one ([AGL-2765](https://linear.app/aglyn/issue/AGL-2765))
- **monitoring:** wire the outage alerts to a second route off the mailbox ([AGL-2757](https://linear.app/aglyn/issue/AGL-2757), [AGL-2734](https://linear.app/aglyn/issue/AGL-2734), [AGL-2723](https://linear.app/aglyn/issue/AGL-2723))

### Fixed

- **e2e:** the besigner spec drives the row menu and a divergent save ([AGL-2862](https://linear.app/aglyn/issue/AGL-2862), [AGL-693](https://linear.app/aglyn/issue/AGL-693), [AGL-674](https://linear.app/aglyn/issue/AGL-674), [AGL-2486](https://linear.app/aglyn/issue/AGL-2486))
- **tools:** refuse to serve a worktree whose node_modules links out of it ([AGL-2860](https://linear.app/aglyn/issue/AGL-2860), [AGL-931](https://linear.app/aglyn/issue/AGL-931))
- **legal:** date the Meta Pixel row by its change-log entry ([AGL-2844](https://linear.app/aglyn/issue/AGL-2844))
- **console:** give the Privacy settings route its payload entry ([AGL-2839](https://linear.app/aglyn/issue/AGL-2839))
- **media:** build the DAM search magnifier once, not per render ([AGL-2854](https://linear.app/aglyn/issue/AGL-2854))
- **ui:** a help tip follows its content, so a late excerpt cannot push it off screen ([AGL-2855](https://linear.app/aglyn/issue/AGL-2855), [AGL-2706](https://linear.app/aglyn/issue/AGL-2706))
- **tenant:** a social card's dimensions follow the asset, not the pick ([AGL-2850](https://linear.app/aglyn/issue/AGL-2850))
- **e2e:** write the private-port emulator config beside the rules it names ([AGL-2858](https://linear.app/aglyn/issue/AGL-2858))
- **besigner:** the canvas and Preview reserve a replaced image's box from its asset ([AGL-2856](https://linear.app/aglyn/issue/AGL-2856), [AGL-2833](https://linear.app/aglyn/issue/AGL-2833), [AGL-2838](https://linear.app/aglyn/issue/AGL-2838), [AGL-2849](https://linear.app/aglyn/issue/AGL-2849))
- **crm:** answer an ID-token outage 5xx, not 401, from plugin server handlers ([AGL-2852](https://linear.app/aglyn/issue/AGL-2852), [AGL-2851](https://linear.app/aglyn/issue/AGL-2851))
- **media:** count CDN deliveries per caller, and refuse past a measured ceiling ([AGL-2812](https://linear.app/aglyn/issue/AGL-2812), [AGL-2825](https://linear.app/aglyn/issue/AGL-2825))
- **media:** stream CDN deliveries rather than holding each file whole in memory ([AGL-2810](https://linear.app/aglyn/issue/AGL-2810))
- **pricing:** re-extract the /pricing frames and reconcile the paid-only CRM rows ([AGL-2831](https://linear.app/aglyn/issue/AGL-2831), [AGL-2851](https://linear.app/aglyn/issue/AGL-2851))
- **tenant:** file a lead only from a routed form, whatever the plan ([AGL-2851](https://linear.app/aglyn/issue/AGL-2851))
- **tools:** new-worktree copies the tenant's .env, where its Firebase config lives ([AGL-2857](https://linear.app/aglyn/issue/AGL-2857))
- **e2e:** the emulated dev servers hold no Stripe, Vercel or Resend credential ([AGL-2828](https://linear.app/aglyn/issue/AGL-2828), [AGL-2834](https://linear.app/aglyn/issue/AGL-2834))
- **e2e:** grant the seeded org release_video_uploads, so the DAM e2e's films land ([AGL-2830](https://linear.app/aglyn/issue/AGL-2830), [AGL-1635](https://linear.app/aglyn/issue/AGL-1635))
- **e2e:** the page connects to the emulators its server was started with ([AGL-2834](https://linear.app/aglyn/issue/AGL-2834))
- **console:** preview draws a replaced film from its asset, not its pick ([AGL-2849](https://linear.app/aglyn/issue/AGL-2849), [AGL-2807](https://linear.app/aglyn/issue/AGL-2807))
- **besigner:** the canvas draws a replaced film from its asset, not its pick ([AGL-2838](https://linear.app/aglyn/issue/AGL-2838), [AGL-2807](https://linear.app/aglyn/issue/AGL-2807), [AGL-2849](https://linear.app/aglyn/issue/AGL-2849))
- **datasets:** index values.email so updateDataset's lookup can run ([AGL-2773](https://linear.app/aglyn/issue/AGL-2773))
- **legal:** hold the brand baseline to the reworded Wistia reason ([AGL-2826](https://linear.app/aglyn/issue/AGL-2826))
- **tools:** exempt the pre-push suite's synthetic ids, and fail a push citing one ([AGL-2837](https://linear.app/aglyn/issue/AGL-2837))
- **legal:** word the Wistia inventory reason without the product brand ([AGL-2826](https://linear.app/aglyn/issue/AGL-2826), [AGL-2852](https://linear.app/aglyn/issue/AGL-2852), [AGL-2832](https://linear.app/aglyn/issue/AGL-2832))
- **commerce:** write the gated player's abort note in American English ([AGL-2814](https://linear.app/aglyn/issue/AGL-2814))
- **commerce:** expire a paid download's link and keep its file private ([AGL-2847](https://linear.app/aglyn/issue/AGL-2847), [AGL-2848](https://linear.app/aglyn/issue/AGL-2848), [AGL-2829](https://linear.app/aglyn/issue/AGL-2829))
- **guards:** count the Wistia note's two company-name mentions in the brand baseline ([AGL-2826](https://linear.app/aglyn/issue/AGL-2826))
- **console:** name the links to a collection's listing before it is deleted ([AGL-2806](https://linear.app/aglyn/issue/AGL-2806), [AGL-2799](https://linear.app/aglyn/issue/AGL-2799), [AGL-2846](https://linear.app/aglyn/issue/AGL-2846))
- **media:** a placed image takes its intrinsic size from the replaced asset ([AGL-2833](https://linear.app/aglyn/issue/AGL-2833), [AGL-2732](https://linear.app/aglyn/issue/AGL-2732), [AGL-2807](https://linear.app/aglyn/issue/AGL-2807))
- **console:** prune the multi-tab records the Firestore SDK strands in localStorage ([AGL-2845](https://linear.app/aglyn/issue/AGL-2845))
- **ci:** run Main Gate's guards even when typecheck or lint is red ([AGL-2835](https://linear.app/aglyn/issue/AGL-2835))
- **commerce:** expire the gated video's delivery link and keep its file private ([AGL-2814](https://linear.app/aglyn/issue/AGL-2814))
- **billing:** name the CRM suite row as /pricing does ([AGL-2790](https://linear.app/aglyn/issue/AGL-2790))
- **console:** scan a component's Link property default for where-used links ([AGL-2846](https://linear.app/aglyn/issue/AGL-2846), [AGL-1893](https://linear.app/aglyn/issue/AGL-1893), [AGL-2847](https://linear.app/aglyn/issue/AGL-2847))
- **crm:** ask the permission catalog for data.manage, not resolveOrgPermissions' map ([AGL-2843](https://linear.app/aglyn/issue/AGL-2843), [AGL-2790](https://linear.app/aglyn/issue/AGL-2790))
- **console:** answer 500, not 401, when a shared helper cannot check a token ([AGL-2816](https://linear.app/aglyn/issue/AGL-2816), [AGL-1993](https://linear.app/aglyn/issue/AGL-1993))
- **ci:** lint with --quiet and grade the log, so a red lint prints its error ([AGL-2829](https://linear.app/aglyn/issue/AGL-2829), [AGL-2842](https://linear.app/aglyn/issue/AGL-2842))
- **legal:** declare the Wistia embed host in the egress inventory ([AGL-2826](https://linear.app/aglyn/issue/AGL-2826))
- **rules:** refuse a lead's delete on a plan without the CRM suite ([AGL-2790](https://linear.app/aglyn/issue/AGL-2790))
- **video:** a placed film takes its length, shape and poster from the asset ([AGL-2807](https://linear.app/aglyn/issue/AGL-2807))
- **media:** a published reference renders the stable URL, so a replace reaches it ([AGL-2798](https://linear.app/aglyn/issue/AGL-2798))
- **docs:** name the Assist helper without the product brand in its evidence ([AGL-2784](https://linear.app/aglyn/issue/AGL-2784))
- **docs:** cite the subprocessors page by path, not by Aglyn's hostname ([AGL-2784](https://linear.app/aglyn/issue/AGL-2784))
- **video:** let the lightbox film shrink so a short screen keeps its controls ([AGL-2827](https://linear.app/aglyn/issue/AGL-2827))
- **scripts:** point the activity guard at the lead conversion writer and run it in CI ([AGL-2823](https://linear.app/aglyn/issue/AGL-2823), [AGL-2627](https://linear.app/aglyn/issue/AGL-2627))
- **rules:** a client may only remove a contact's consent entries, never grant one ([AGL-2821](https://linear.app/aglyn/issue/AGL-2821))
- **api:** refuse a contact's suite fields over /v1 on a plan without the CRM suite ([AGL-2822](https://linear.app/aglyn/issue/AGL-2822), [AGL-2804](https://linear.app/aglyn/issue/AGL-2804))
- **rules:** a contact is created by the server, never by a client ([AGL-2819](https://linear.app/aglyn/issue/AGL-2819), [AGL-2804](https://linear.app/aglyn/issue/AGL-2804))
- **crm:** move every write to a contact's facets behind the CRM routes ([AGL-2804](https://linear.app/aglyn/issue/AGL-2804), [AGL-2820](https://linear.app/aglyn/issue/AGL-2820), [AGL-2822](https://linear.app/aglyn/issue/AGL-2822))
- **console:** show Assist readers fixed copy, not the model provider's error text ([AGL-2815](https://linear.app/aglyn/issue/AGL-2815), [AGL-2797](https://linear.app/aglyn/issue/AGL-2797))
- **dam:** stop counting a media CDN HEAD as a full-size serve ([AGL-2811](https://linear.app/aglyn/issue/AGL-2811))
- **auth:** log the link-mint throttle as a throttle, not an internal error ([AGL-2803](https://linear.app/aglyn/issue/AGL-2803), [AGL-2584](https://linear.app/aglyn/issue/AGL-2584))
- **console:** a folder or SSO 5xx answers fixed copy, never the thrown message ([AGL-2797](https://linear.app/aglyn/issue/AGL-2797), [AGL-2796](https://linear.app/aglyn/issue/AGL-2796))
- **console:** answer 401, not 5xx, when any console route gets a refused ID token ([AGL-2796](https://linear.app/aglyn/issue/AGL-2796), [AGL-1993](https://linear.app/aglyn/issue/AGL-1993), [AGL-1921](https://linear.app/aglyn/issue/AGL-1921), [AGL-2785](https://linear.app/aglyn/issue/AGL-2785), [AGL-2807](https://linear.app/aglyn/issue/AGL-2807))
- **tenant:** write form records only where the page signed, not where the body says ([AGL-2773](https://linear.app/aglyn/issue/AGL-2773))
- **docs:** stop telling customers Aglyn Assist is rolling out when it is live ([AGL-2784](https://linear.app/aglyn/issue/AGL-2784), [AGL-2805](https://linear.app/aglyn/issue/AGL-2805))
- **console:** load plugin field types before a console record write validates ([AGL-2773](https://linear.app/aglyn/issue/AGL-2773))
- **tenant:** load the datasets a page repeats over, not the first fifty the site can see ([AGL-2773](https://linear.app/aglyn/issue/AGL-2773))
- **rules:** the CRM suite's collections ask the plan on create and update ([AGL-2801](https://linear.app/aglyn/issue/AGL-2801))
- **crm:** lock the CRM suite's actions on Contacts for a plan without it ([AGL-2788](https://linear.app/aglyn/issue/AGL-2788))
- **crm:** refuse the CRM suite's routes to a plan without the suite ([AGL-2787](https://linear.app/aglyn/issue/AGL-2787), [AGL-2802](https://linear.app/aglyn/issue/AGL-2802))
- **tenant:** render a repeat's first records in editor order, not an id sample ([AGL-2773](https://linear.app/aglyn/issue/AGL-2773))
- **billing:** measure dataset warnings against the limit a create is refused at ([AGL-2773](https://linear.app/aglyn/issue/AGL-2773))
- **console:** offer only datasets the site can see in the page-editor picker ([AGL-2773](https://linear.app/aglyn/issue/AGL-2773))
- **console:** refuse an unstorable media sharing choice, and guard the widening ([AGL-2773](https://linear.app/aglyn/issue/AGL-2773))
- **data:** refuse a sharing choice the dataset cannot store instead of widening it ([AGL-2773](https://linear.app/aglyn/issue/AGL-2773))
- **tenant:** record a dataset step that saved nothing as failed, not saved ([AGL-2773](https://linear.app/aglyn/issue/AGL-2773))
- **workflows:** offer every current dataset in the Actions dataset picker ([AGL-2773](https://linear.app/aglyn/issue/AGL-2773))
- **marketing:** say which plan limits refuse and which meter, and who owns datasets ([AGL-2774](https://linear.app/aglyn/issue/AGL-2774))
- **console:** say pages past the publish cap catch up within the hour ([AGL-2774](https://linear.app/aglyn/issue/AGL-2774))
- **api:** describe /v1 write bodies, deletes and creates the way the handlers answer ([AGL-2774](https://linear.app/aglyn/issue/AGL-2774))
- **shared-ui-next:** a locked hub section names its lock to assistive technology ([AGL-2794](https://linear.app/aglyn/issue/AGL-2794))
- **tools:** keep the renditions an earlier run made when --webm adds one ([AGL-2800](https://linear.app/aglyn/issue/AGL-2800))
- **shared-ui-next:** a locked hub section is laid out like every other tab ([AGL-2783](https://linear.app/aglyn/issue/AGL-2783), [AGL-2800](https://linear.app/aglyn/issue/AGL-2800))
- **e2e:** emulate Storage in the emulated serve scripts, not only Auth and Firestore ([AGL-2795](https://linear.app/aglyn/issue/AGL-2795))
- **video:** send the play beacon the collector has been waiting for ([AGL-2781](https://linear.app/aglyn/issue/AGL-2781), [AGL-2746](https://linear.app/aglyn/issue/AGL-2746), [AGL-2798](https://linear.app/aglyn/issue/AGL-2798))
- **tools:** describe the canary's App Check secret without naming the variable ([AGL-2780](https://linear.app/aglyn/issue/AGL-2780), [AGL-2758](https://linear.app/aglyn/issue/AGL-2758))
- **console:** declare the Monitoring and Cloud Run hosts the setup scripts call ([AGL-2780](https://linear.app/aglyn/issue/AGL-2780), [AGL-2757](https://linear.app/aglyn/issue/AGL-2757), [AGL-2758](https://linear.app/aglyn/issue/AGL-2758))
- **errors:** drop stacks thrown wholly under iabjs:// or extension schemes ([AGL-2786](https://linear.app/aglyn/issue/AGL-2786), [AGL-2523](https://linear.app/aglyn/issue/AGL-2523))
- **console:** answer 401, not 500, when the edit-hint mint gets a revoked token ([AGL-2785](https://linear.app/aglyn/issue/AGL-2785), [AGL-1993](https://linear.app/aglyn/issue/AGL-1993), [AGL-2797](https://linear.app/aglyn/issue/AGL-2797), [AGL-2769](https://linear.app/aglyn/issue/AGL-2769))
- **release:** verify every manual deploy target on a promotion, not only the range's ([AGL-2793](https://linear.app/aglyn/issue/AGL-2793), [AGL-2791](https://linear.app/aglyn/issue/AGL-2791))
- **console:** declare the Monitoring and Run admin APIs the setup scripts call ([AGL-2777](https://linear.app/aglyn/issue/AGL-2777), [AGL-1648](https://linear.app/aglyn/issue/AGL-1648), [AGL-2757](https://linear.app/aglyn/issue/AGL-2757), [AGL-2758](https://linear.app/aglyn/issue/AGL-2758))
- **monitoring:** describe the canary's App Check debug token instead of naming it ([AGL-2778](https://linear.app/aglyn/issue/AGL-2778), [AGL-2402](https://linear.app/aglyn/issue/AGL-2402), [AGL-2793](https://linear.app/aglyn/issue/AGL-2793), [AGL-2776](https://linear.app/aglyn/issue/AGL-2776))
- **marketing:** the Explore grid's slot count follows the copy, not a fixed seven ([AGL-2769](https://linear.app/aglyn/issue/AGL-2769))
- **commerce:** send the entitlement hop to a delivery copy, not the master ([AGL-2766](https://linear.app/aglyn/issue/AGL-2766), [AGL-2753](https://linear.app/aglyn/issue/AGL-2753), [AGL-2745](https://linear.app/aglyn/issue/AGL-2745))
- **tools:** build the alert policy names from configuration, and re-read the id ceiling ([AGL-2767](https://linear.app/aglyn/issue/AGL-2767), [AGL-2757](https://linear.app/aglyn/issue/AGL-2757), [AGL-2765](https://linear.app/aglyn/issue/AGL-2765), [AGL-2766](https://linear.app/aglyn/issue/AGL-2766))
- **dam:** measure the storage band when a signed replace is minted, not only at finalize ([AGL-2732](https://linear.app/aglyn/issue/AGL-2732))
- **docs:** clear the baselined British spellings from published copy ([AGL-2764](https://linear.app/aglyn/issue/AGL-2764), [AGL-2763](https://linear.app/aglyn/issue/AGL-2763))
- **agents:** resolve a screen link in the Markdown wherever its value is stored ([AGL-2740](https://linear.app/aglyn/issue/AGL-2740), [AGL-1998](https://linear.app/aglyn/issue/AGL-1998))
- **monitoring:** keep an unprovisioned address out of the alerting script ([AGL-2757](https://linear.app/aglyn/issue/AGL-2757), [AGL-1577](https://linear.app/aglyn/issue/AGL-1577))
- **docs:** drop the British spellings from the Besigner styling pages ([AGL-2763](https://linear.app/aglyn/issue/AGL-2763), [AGL-2025](https://linear.app/aglyn/issue/AGL-2025), [AGL-2170](https://linear.app/aglyn/issue/AGL-2170), [AGL-2752](https://linear.app/aglyn/issue/AGL-2752), [AGL-2762](https://linear.app/aglyn/issue/AGL-2762))
- **crm:** log a create from the org hub to the org, not to the picked site ([AGL-2760](https://linear.app/aglyn/issue/AGL-2760), [AGL-2738](https://linear.app/aglyn/issue/AGL-2738))

### Reverted

- **crm:** drop the read-only Leads mode built for Free ([AGL-2851](https://linear.app/aglyn/issue/AGL-2851))

### Documentation

- **selfhost:** give the browser's three emulator hosts a row in the reference ([AGL-2859](https://linear.app/aglyn/issue/AGL-2859), [AGL-2834](https://linear.app/aglyn/issue/AGL-2834))
- **tenant:** the stored card pair is the fallback, and what the card costs is counted ([AGL-2850](https://linear.app/aglyn/issue/AGL-2850))
- **getting-started:** capture the Assist panel help tip, A15's flag having shipped ([AGL-2805](https://linear.app/aglyn/issue/AGL-2805), [AGL-1635](https://linear.app/aglyn/issue/AGL-1635))
- **media:** say exactly which CDN requests the per-caller limit counts ([AGL-2812](https://linear.app/aglyn/issue/AGL-2812))
- **crm:** drop the claims that Free keeps the CRM's contacts from code comments ([AGL-2851](https://linear.app/aglyn/issue/AGL-2851))
- **crm:** say the CRM starts at Starter and Free has none of it ([AGL-2851](https://linear.app/aglyn/issue/AGL-2851))
- **video:** point the paused-upload note at Wistia-hosted video ([AGL-2830](https://linear.app/aglyn/issue/AGL-2830))
- **crm:** say Free opens the CRM on read-only Leads and Contacts join the suite ([AGL-2790](https://linear.app/aglyn/issue/AGL-2790))
- **video:** place a Wistia video with the Video element ([AGL-2826](https://linear.app/aglyn/issue/AGL-2826))
- **crm:** the contacts table's Set stage announces Contact changed stage ([AGL-2820](https://linear.app/aglyn/issue/AGL-2820), [AGL-2804](https://linear.app/aglyn/issue/AGL-2804))
- **billing:** say the bandwidth meter counts page views, not what a page weighs ([AGL-2813](https://linear.app/aglyn/issue/AGL-2813))
- **crm:** say exactly what Free gets from the CRM ([AGL-2789](https://linear.app/aglyn/issue/AGL-2789))
- **datasets:** correct validation, sharing, quota and navigation claims ([AGL-2774](https://linear.app/aglyn/issue/AGL-2774))
- **api:** describe dataset endpoints, scopes and usage bands as they behave ([AGL-2774](https://linear.app/aglyn/issue/AGL-2774))
...
- **e2e:** drive the Free CRM as locked, with the privacy door and a Starter control ([AGL-2851](https://linear.app/aglyn/issue/AGL-2851), [AGL-2839](https://linear.app/aglyn/issue/AGL-2839))
- **console:** pin the one paid-only CRM row the pricing page publishes ([AGL-2831](https://linear.app/aglyn/issue/AGL-2831))
- **aglyn:** allowlist the gated-media backfill's first-party apexes ([AGL-2814](https://linear.app/aglyn/issue/AGL-2814))
- **crm:** pin the shipped rail's plan split in the plugin, not the console ([AGL-2790](https://linear.app/aglyn/issue/AGL-2790))
- **main-gate:** sweep every push to main as one queued unit, not an hourly debounce ([AGL-2836](https://linear.app/aglyn/issue/AGL-2836), [AGL-2552](https://linear.app/aglyn/issue/AGL-2552))
- **console:** give the host setup specs the real release-flag registry ([AGL-2830](https://linear.app/aglyn/issue/AGL-2830))
- **e2e:** drive the Free CRM as read-only Leads with Contacts locked ([AGL-2790](https://linear.app/aglyn/issue/AGL-2790))
- **console:** pin /pricing's view-only leads row and the suite row with contacts ([AGL-2831](https://linear.app/aglyn/issue/AGL-2831), [AGL-2790](https://linear.app/aglyn/issue/AGL-2790))
- **console:** prove record writes load plugin field types without importing an add-on ([AGL-2773](https://linear.app/aglyn/issue/AGL-2773), [AGL-2829](https://linear.app/aglyn/issue/AGL-2829))
- **console:** declare the datasets banner as an indirect quota surface ([AGL-2773](https://linear.app/aglyn/issue/AGL-2773))
- **console:** give the email properties spec the scope tokens its picker reads ([AGL-2773](https://linear.app/aglyn/issue/AGL-2773))
- **shared-ui-next:** run the hub rail spec, so check:test-wiring stops failing main ([AGL-2818](https://linear.app/aglyn/issue/AGL-2818), [AGL-2783](https://linear.app/aglyn/issue/AGL-2783))
- **e2e:** write the DAM spec's preflight media document through putMediaDocument ([AGL-2817](https://linear.app/aglyn/issue/AGL-2817), [AGL-1488](https://linear.app/aglyn/issue/AGL-1488), [AGL-2782](https://linear.app/aglyn/issue/AGL-2782), [AGL-2802](https://linear.app/aglyn/issue/AGL-2802))
- **e2e:** drive the CRM plan gate on a Free workspace, with a Starter control ([AGL-2809](https://linear.app/aglyn/issue/AGL-2809), [AGL-2787](https://linear.app/aglyn/issue/AGL-2787), [AGL-2788](https://linear.app/aglyn/issue/AGL-2788), [AGL-2801](https://linear.app/aglyn/issue/AGL-2801))
- **e2e:** fill the contact record's Phone field, not the Call button's tooltip ([AGL-2808](https://linear.app/aglyn/issue/AGL-2808), [AGL-2661](https://linear.app/aglyn/issue/AGL-2661))
- **e2e:** drive the DAM, the video pipeline and the lightbox end to end ([AGL-2782](https://linear.app/aglyn/issue/AGL-2782), [AGL-2802](https://linear.app/aglyn/issue/AGL-2802))
- **console:** expect the American Licenses copy the marketplace renders ([AGL-2780](https://linear.app/aglyn/issue/AGL-2780), [AGL-2764](https://linear.app/aglyn/issue/AGL-2764))
- **console:** sweep the /v1 upload door in both storage-gate inventories ([AGL-2792](https://linear.app/aglyn/issue/AGL-2792), [AGL-2075](https://linear.app/aglyn/issue/AGL-2075), [AGL-2003](https://linear.app/aglyn/issue/AGL-2003), [AGL-2463](https://linear.app/aglyn/issue/AGL-2463))
- **console:** count the replace route's mint-leg storage gate as the fifth door ([AGL-2780](https://linear.app/aglyn/issue/AGL-2780), [AGL-2732](https://linear.app/aglyn/issue/AGL-2732))
- **console:** count replace's sign-time storage gate as the fifth door ([AGL-2779](https://linear.app/aglyn/issue/AGL-2779), [AGL-2732](https://linear.app/aglyn/issue/AGL-2732))
- **console:** assert the Licenses copy, and let its absence checks fail again ([AGL-2776](https://linear.app/aglyn/issue/AGL-2776), [AGL-2764](https://linear.app/aglyn/issue/AGL-2764))
- **console:** re-inject the false comment opener the stripper spec measures ([AGL-2732](https://linear.app/aglyn/issue/AGL-2732), [AGL-2501](https://linear.app/aglyn/issue/AGL-2501))
...
- **api-v1:** publish an OpenAPI 3.1 description of the customer REST API ([AGL-2733](https://linear.app/aglyn/issue/AGL-2733), [AGL-617](https://linear.app/aglyn/issue/AGL-617))

## v1.0.0-beta.111 — 2026-09-10
...
- **cli:** @aglyn/cli 0.1.2 ([AGL-2724](https://linear.app/aglyn/issue/AGL-2724))
...
- **commerce,aglyn,tenant:** the lead event names its lead; the webhook step is proven ([AGL-2627](https://linear.app/aglyn/issue/AGL-2627))
- **console,tenant,crm:** /v1/leads reads, works and converts a site's leads ([AGL-2627](https://linear.app/aglyn/issue/AGL-2627))
- **crm:** the contact and lead pages offer a person's erasure, with a pending banner ([AGL-2623](https://linear.app/aglyn/issue/AGL-2623))
- **console:** the daily erasure job drains the person queue after the workspaces ([AGL-2623](https://linear.app/aglyn/issue/AGL-2623))
- **crm:** crm/erase-person files a person's erasure for the daily job ([AGL-2623](https://linear.app/aglyn/issue/AGL-2623))
- **workflows:** the actions card offers the CRM recipes beside Add action ([AGL-2626](https://linear.app/aglyn/issue/AGL-2626))
- **tenant:** erasePerson removes one person from all a workspace keeps beside them ([AGL-2623](https://linear.app/aglyn/issue/AGL-2623))
- **crm,docs:** the org-level contact carries its Known-by column and card ([AGL-2630](https://linear.app/aglyn/issue/AGL-2630))
- **crm:** the record page merges into another contact and finds likely duplicates ([AGL-2625](https://linear.app/aglyn/issue/AGL-2625))
- **tenant,crm:** an erased person is not rebuilt by the next capture ([AGL-2623](https://linear.app/aglyn/issue/AGL-2623))
- **aglyn:** the step catalog carries the four CRM recipes the builder and docs share ([AGL-2626](https://linear.app/aglyn/issue/AGL-2626))
- **aglyn,tenant-runtime:** contactCreated carries the form a capture came through ([AGL-2626](https://linear.app/aglyn/issue/AGL-2626))
- **crm:** the org-level leads section reads every site, and a lead's address names it ([AGL-2630](https://linear.app/aglyn/issue/AGL-2630))
- **aglyn:** a person's privacy erasure has a request shape, a marker and one list ([AGL-2623](https://linear.app/aglyn/issue/AGL-2623))
- **console:** the v1 merge endpoint folds a contact into the one in its path ([AGL-2625](https://linear.app/aglyn/issue/AGL-2625))
- **crm:** every section, record page and card mounts at the organization level ([AGL-2630](https://linear.app/aglyn/issue/AGL-2630))
- **crm,aglyn,tenant:** merge two contacts on the server behind an email index ([AGL-2625](https://linear.app/aglyn/issue/AGL-2625))
- **crm:** every CRM listener drops its scope clause at the organization level ([AGL-2630](https://linear.app/aglyn/issue/AGL-2630))
- **crm:** the top open deals and the tasks by assignee export their tables as CSV ([AGL-2624](https://linear.app/aglyn/issue/AGL-2624))
- **crm:** the glance card counts the leads still to work as its fifth figure ([AGL-2624](https://linear.app/aglyn/issue/AGL-2624))
- **crm:** the leaderboard, lead funnel and source conversion cards join the reports ([AGL-2624](https://linear.app/aglyn/issue/AGL-2624))
- **console,crm:** the org-level CRM hub mounts the contacts section over every site ([AGL-2630](https://linear.app/aglyn/issue/AGL-2630))
- **crm:** the tasks list completes, assigns, reschedules, exports and deletes in bulk ([AGL-2621](https://linear.app/aglyn/issue/AGL-2621))
- **crm:** the deals table selects, moves, reassigns, loses, exports and deletes in bulk ([AGL-2621](https://linear.app/aglyn/issue/AGL-2621))
- **crm:** a companies file imports through the contacts drawer's own walk ([AGL-2621](https://linear.app/aglyn/issue/AGL-2621))
- **crm,docs:** the reports section forecasts the open pipeline by close month ([AGL-2620](https://linear.app/aglyn/issue/AGL-2620))
- **console,docs:** /v1/deals carries lineItems; an archived pipeline takes no deal ([AGL-2620](https://linear.app/aglyn/issue/AGL-2620))
- **crm:** the contact, lead and deal pages send one person an email ([AGL-2615](https://linear.app/aglyn/issue/AGL-2615))
- **crm,docs:** a Products card puts line items behind a deal's amount ([AGL-2620](https://linear.app/aglyn/issue/AGL-2620))
- **crm:** the companies table selects, tags, reassigns, exports and deletes in bulk ([AGL-2621](https://linear.app/aglyn/issue/AGL-2621))
- **crm:** a lead's page carries its own activity log ([AGL-2615](https://linear.app/aglyn/issue/AGL-2615))
- **crm:** a sent email shows its subject, recipient and delivery state on the timeline ([AGL-2615](https://linear.app/aglyn/issue/AGL-2615))
- **crm:** the Stages dialog becomes Pipelines, with a switcher on board and table ([AGL-2620](https://linear.app/aglyn/issue/AGL-2620))
- **crm:** one CSV serializer and an Export CSV control for the report tables ([AGL-2624](https://linear.app/aglyn/issue/AGL-2624))
- **crm:** one bulk runner for every CRM collection, and a CSV per section ([AGL-2621](https://linear.app/aglyn/issue/AGL-2621))
- **aglyn:** report arithmetic for the leaderboard, lead funnel and source conversion ([AGL-2624](https://linear.app/aglyn/issue/AGL-2624))
- **aglyn:** a deal carries line items and a pipeline can be archived ([AGL-2620](https://linear.app/aglyn/issue/AGL-2620))
- **crm:** the contacts export carries every CRM column under the import's header ([AGL-2621](https://linear.app/aglyn/issue/AGL-2621))
- **aglyn:** the CSV import stages are shared and a companies file has its vocabulary ([AGL-2621](https://linear.app/aglyn/issue/AGL-2621))
- **email:** a dynamic list can select the people who engaged with a campaign lately ([AGL-2616](https://linear.app/aglyn/issue/AGL-2616))
- **console:** the Daily CRM digest switch beside the notification mutes ([AGL-2619](https://linear.app/aglyn/issue/AGL-2619))
- **crm:** snooze a task to tomorrow, next week or a date in one write ([AGL-2619](https://linear.app/aglyn/issue/AGL-2619))
- **crm:** the timeline shows campaign email and the record when they last engaged ([AGL-2616](https://linear.app/aglyn/issue/AGL-2616))
- **console:** the daily CRM digest route, scheduled at 08:00 Chicago ([AGL-2619](https://linear.app/aglyn/issue/AGL-2619))
- **tenant-runtime:** an automation's email to the contact lands on the timeline ([AGL-2615](https://linear.app/aglyn/issue/AGL-2615))
- **marketing:** the delivery webhook maps a one-to-one email's events onto its activity ([AGL-2615](https://linear.app/aglyn/issue/AGL-2615))
- **crm:** crm/email-send mails one person from their record, capped and logged ([AGL-2615](https://linear.app/aglyn/issue/AGL-2615))
- **aglyn:** the daily CRM digest model, its notification type and the digest switch ([AGL-2619](https://linear.app/aglyn/issue/AGL-2619))
- **tenant,marketing:** the webhook stamps the contact facet on a first open or click ([AGL-2616](https://linear.app/aglyn/issue/AGL-2616))
- **email:** a dynamic list can reuse a saved Contacts view beside a segment ([AGL-2617](https://linear.app/aglyn/issue/AGL-2617))
- **tenant-data-admin:** the delivery webhook advances an email activity transactionally ([AGL-2615](https://linear.app/aglyn/issue/AGL-2615))
- **aglyn,tenant:** the timeline model carries campaign email, the facet its stamp ([AGL-2616](https://linear.app/aglyn/issue/AGL-2616))
- **aglyn:** an email activity carries its subject, recipient and delivery state ([AGL-2615](https://linear.app/aglyn/issue/AGL-2615))
- **tenant:** the dynamic-list sweep resolves a saved contacts view beside a segment ([AGL-2617](https://linear.app/aglyn/issue/AGL-2617))
- **crm:** the four other lists keep filter, columns and sort as a saved view ([AGL-2617](https://linear.app/aglyn/issue/AGL-2617))
- **crm:** the Contacts list is a saved view — filters, columns and sort under a name ([AGL-2617](https://linear.app/aglyn/issue/AGL-2617))
- **crm:** adds, deletes and conversions in the CRM write the site's activity log ([AGL-2622](https://linear.app/aglyn/issue/AGL-2622))
- **inbox:** the dashboard's Inbox card counts the open leads and links to the CRM ([AGL-2622](https://linear.app/aglyn/issue/AGL-2622))
- **crm,inbox,commerce:** timeline entries and the orders count open their records ([AGL-2622](https://linear.app/aglyn/issue/AGL-2622))
- **workflows:** the owner step's editor offers a member or the round-robin pool ([AGL-2618](https://linear.app/aglyn/issue/AGL-2618))
- **crm:** settings gain a site default owner, assignment rules and a round-robin pool ([AGL-2618](https://linear.app/aglyn/issue/AGL-2618))
- **aglyn,crm:** a saved view is a list's filters, columns and sort under a name ([AGL-2617](https://linear.app/aglyn/issue/AGL-2617))
- **commerce,bookings,console:** orders, bookings and site users open their CRM contact ([AGL-2622](https://linear.app/aglyn/issue/AGL-2622))
- **console:** billing meters and plan cards read CRM records and the daily email cap ([AGL-2611](https://linear.app/aglyn/issue/AGL-2611))
- **billing:** the usage rollup bills the CRM records band on its period-end trio ([AGL-2611](https://linear.app/aglyn/issue/AGL-2611))
- **crm:** a converted lead's contact is owned by the picker, the rules, or the converter ([AGL-2618](https://linear.app/aglyn/issue/AGL-2618))
- **rules:** the one-to-one email counter is member-readable and server-written ([AGL-2611](https://linear.app/aglyn/issue/AGL-2611))
- **console:** search finds leads, companies and deals, each opening its CRM record ([AGL-2622](https://linear.app/aglyn/issue/AGL-2622))
- **tenant-runtime:** the owner step can rotate, and assigns through the one pass ([AGL-2618](https://linear.app/aglyn/issue/AGL-2618))
- **tenant-runtime:** one server pass decides who a new record belongs to ([AGL-2618](https://linear.app/aglyn/issue/AGL-2618))
- **aglyn:** one shared builder addresses CRM records and the site pages a timeline names ([AGL-2622](https://linear.app/aglyn/issue/AGL-2622))
- **aglyn:** an assigned contact or lead is a notification; the owner step can rotate ([AGL-2618](https://linear.app/aglyn/issue/AGL-2618))
- **aglyn:** assignment rules, a site default owner and a round-robin pool under crm ([AGL-2618](https://linear.app/aglyn/issue/AGL-2618))
- **console:** sections and widgets gate on their own flag; the CRM locks its suite ([AGL-2611](https://linear.app/aglyn/issue/AGL-2611))
- **crm:** one record header on all four record pages; the deal board scrolls sideways ([AGL-2614](https://linear.app/aglyn/issue/AGL-2614))
- **crm:** every section and record card opens on the shared empty state and its action ([AGL-2614](https://linear.app/aglyn/issue/AGL-2614))
- **crm:** an owner or assignee is a member, by uid or by address, never by address alone ([AGL-2614](https://linear.app/aglyn/issue/AGL-2614), [AGL-1122](https://linear.app/aglyn/issue/AGL-1122))
- **crm:** a company's contacts and the leads pay the list footer; the owed list 17 → 15 ([AGL-2614](https://linear.app/aglyn/issue/AGL-2614))
- **crm:** a capture links the company at the email domain; Settings can create it ([AGL-2613](https://linear.app/aglyn/issue/AGL-2613))
- **crm:** the company picker is wired into the drawer, the record page and the bulk bar ([AGL-2613](https://linear.app/aglyn/issue/AGL-2613))
- **crm:** one planner for the contact–company link and the company's contacts count ([AGL-2613](https://linear.app/aglyn/issue/AGL-2613))
- **crm:** the form page, Leads, the record and the Inbox say what becomes a lead ([AGL-2612](https://linear.app/aglyn/issue/AGL-2612))
- **crm:** the Contacts list opens on a form's captures or one address from its own URL ([AGL-2612](https://linear.app/aglyn/issue/AGL-2612))
- **crm:** every capture door stamps the earliest lifecycle stage, never downgrading ([AGL-2612](https://linear.app/aglyn/issue/AGL-2612))
- **crm:** every record door measures the records band; the suite gates steps and the API ([AGL-2611](https://linear.app/aglyn/issue/AGL-2611))
- **entitlements:** the CRM suite gates from Starter and the band counts CRM records ([AGL-2611](https://linear.app/aglyn/issue/AGL-2611))

### Fixed

- **crm:** the org-level deals table has its pipeline index twin ([AGL-2630](https://linear.app/aglyn/issue/AGL-2630))
- **crm,console,docs:** the consolidated CRM v2.1 tree clears every guard ([AGL-2614](https://linear.app/aglyn/issue/AGL-2614))
- **crm,workflows:** the consolidated CRM v2.1 tree clears every guard ([AGL-2614](https://linear.app/aglyn/issue/AGL-2614))
- **crm:** an org-level create defaults its Site picker to the record it was opened from ([AGL-2630](https://linear.app/aglyn/issue/AGL-2630))
- **tools:** the e2e seed enables the CRM under its current plugin id ([AGL-2630](https://linear.app/aglyn/issue/AGL-2630), [AGL-2614](https://linear.app/aglyn/issue/AGL-2614))
- **crm:** the consolidated CRM v2.1 tree clears every guard ([AGL-2614](https://linear.app/aglyn/issue/AGL-2614), [AGL-2625](https://linear.app/aglyn/issue/AGL-2625))
- **console:** the pending-erasures card runs a people-only queue early ([AGL-2623](https://linear.app/aglyn/issue/AGL-2623))
- **crm,docs:** the consolidated CRM v2.1 tree clears every guard ([AGL-2614](https://linear.app/aglyn/issue/AGL-2614), [AGL-2621](https://linear.app/aglyn/issue/AGL-2621))
- **crm,docs:** the consolidated CRM v2.1 tree clears every guard ([AGL-2614](https://linear.app/aglyn/issue/AGL-2614), [AGL-2621](https://linear.app/aglyn/issue/AGL-2621), [AGL-2620](https://linear.app/aglyn/issue/AGL-2620))
- **crm:** the Pipeline card charts an archived pipeline only while a deal is open in it ([AGL-2620](https://linear.app/aglyn/issue/AGL-2620))
- **crm:** the companies bar builds its plan in one expression ([AGL-2621](https://linear.app/aglyn/issue/AGL-2621))
- **crm,forms,jsx,docs:** the consolidated CRM v2.1 tree clears every guard ([AGL-2614](https://linear.app/aglyn/issue/AGL-2614))
- **console:** the digest zone spec hands the reader an environment the console types ([AGL-2614](https://linear.app/aglyn/issue/AGL-2614))
- **crm,email:** a view's empty column list means the list's default, not every column ([AGL-2614](https://linear.app/aglyn/issue/AGL-2614))
- **crm:** the views dialog links its manual; the companies spec stubs the logger ([AGL-2614](https://linear.app/aglyn/issue/AGL-2614))
- **crm,console,aglyn:** the consolidated CRM v2.1 tree clears every guard ([AGL-2614](https://linear.app/aglyn/issue/AGL-2614))
- **console:** the footer ratchet retires the company picker its detector no longer sees ([AGL-2614](https://linear.app/aglyn/issue/AGL-2614))
- **commerce,bookings:** the CRM link comes from the shared builder, not the plugin ([AGL-2622](https://linear.app/aglyn/issue/AGL-2622))

### Performance

- **crm:** report reads are remembered a minute by scope and period; Refresh forgets ([AGL-2614](https://linear.app/aglyn/issue/AGL-2614))

### Changed

- **crm:** one useOrgMemberOptions ([AGL-2614](https://linear.app/aglyn/issue/AGL-2614))
- **aglyn,crm,inbox:** the two dashboard lead counts share one definition of closed ([AGL-2624](https://linear.app/aglyn/issue/AGL-2624))
- **aglyn:** the leaderboard keeps its name clock beside the rows, not on them ([AGL-2624](https://linear.app/aglyn/issue/AGL-2624))
- **crm:** one scope hook — useDealScope folds into useCrmScope with one shape ([AGL-2614](https://linear.app/aglyn/issue/AGL-2614))

### Documentation

- **docs,console:** the API documents leads, the lead id and the CRM webhook payloads ([AGL-2627](https://linear.app/aglyn/issue/AGL-2627))
- **docs:** deleting a contact and erasing a person are two acts, and the docs say so ([AGL-2623](https://linear.app/aglyn/issue/AGL-2623))
- **docs,console,aglyn:** the CRM automations page lists the recipes and what each builds ([AGL-2626](https://linear.app/aglyn/issue/AGL-2626))
- **docs:** the contact record and the REST contacts resource describe the merge ([AGL-2625](https://linear.app/aglyn/issue/AGL-2625))
- **docs:** the reports description names the new cards in one breath ([AGL-2624](https://linear.app/aglyn/issue/AGL-2624))
- **docs:** the CRM manual explains each section's bulk bar and the files that re-import ([AGL-2621](https://linear.app/aglyn/issue/AGL-2621))
- **docs:** reports covers the leaderboard, lead funnel, source conversion and exports ([AGL-2624](https://linear.app/aglyn/issue/AGL-2624))
- **docs:** one-to-one email: dialog, delivery states, daily cap, automated row ([AGL-2615](https://linear.app/aglyn/issue/AGL-2615))
- **docs:** the CRM manual pictures the hub with house mockups, not captures ([AGL-2628](https://linear.app/aglyn/issue/AGL-2628))
- **docs,crm:** the contacts and campaign guides describe campaign email on the timeline ([AGL-2616](https://linear.app/aglyn/issue/AGL-2616))
- **docs:** the daily digest, the snooze, the digest switch and the schedule exemption ([AGL-2619](https://linear.app/aglyn/issue/AGL-2619))
- **docs:** the CRM manual shows the v2 hub: contacts, a record, Leads and Reports ([AGL-2628](https://linear.app/aglyn/issue/AGL-2628))
- **docs:** the CRM manual gains Saved views, after Bulk actions ([AGL-2617](https://linear.app/aglyn/issue/AGL-2617))
- **docs:** the manual maps everywhere the CRM shows up; each surface names its link ([AGL-2622](https://linear.app/aglyn/issue/AGL-2622))
- **docs:** the CRM manual explains owner assignment, rotation and what a lead inherits ([AGL-2618](https://linear.app/aglyn/issue/AGL-2618))
- **decisions:** the CRM records band, suite gate and email caps are on the index ([AGL-2611](https://linear.app/aglyn/issue/AGL-2611))
- **docs:** the CRM prices as a records band, a suite gate and daily email caps ([AGL-2611](https://linear.app/aglyn/issue/AGL-2611))
- **docs:** the CRM manual follows the paged cards, header, report memory and member id ([AGL-2614](https://linear.app/aglyn/issue/AGL-2614))
- **docs:** the CRM manual says which captures set a stage and what makes a lead ([AGL-2612](https://linear.app/aglyn/issue/AGL-2612))

<details>
<summary>Also in this release: 9 test, 4 chore</summary>

- **e2e:** the org-hub spec resets the site's book to the fixture ([AGL-2610](https://linear.app/aglyn/issue/AGL-2610))
- **e2e:** the leads spec unqualifies through the header's overflow ([AGL-2610](https://linear.app/aglyn/issue/AGL-2610), [AGL-2614](https://linear.app/aglyn/issue/AGL-2614))
- **docs:** the consolidated CRM v2.1 tree regenerates its registries ([AGL-2614](https://linear.app/aglyn/issue/AGL-2614))
- **e2e:** the org-level CRM hub gets its browser script on the CRM harness ([AGL-2630](https://linear.app/aglyn/issue/AGL-2630))
- **e2e:** the seeds enable `crm`; a board card's menu is matched by its whole label ([AGL-2620](https://linear.app/aglyn/issue/AGL-2620))
- **e2e:** the deals board, the Pipelines dialog, line items and the forecast are driven ([AGL-2620](https://linear.app/aglyn/issue/AGL-2620), [AGL-2610](https://linear.app/aglyn/issue/AGL-2610))
- **tools:** the Linear ceiling reads AGL-2630 for the org-level CRM hub ([AGL-2630](https://linear.app/aglyn/issue/AGL-2630))
- **workflows:** the card spec reads the contactCreated payload with its stage ([AGL-2614](https://linear.app/aglyn/issue/AGL-2614))
- **crm,console,tenant:** the pricing and company-link doubles know each other ([AGL-2614](https://linear.app/aglyn/issue/AGL-2614))
- **docs:** the feature matrix carries the crm flag ([AGL-2611](https://linear.app/aglyn/issue/AGL-2611))
- **billing:** the CRM axis clears 80% at the annual price; a rateless band is hard ([AGL-2611](https://linear.app/aglyn/issue/AGL-2611))
- **aglyn:** the contacts plugin-id alias retires; canonicalPluginId stays as the seam ([AGL-2614](https://linear.app/aglyn/issue/AGL-2614))
- **crm:** the seeded Contacts list is proven at the query ([AGL-2612](https://linear.app/aglyn/issue/AGL-2612), [AGL-2605](https://linear.app/aglyn/issue/AGL-2605))
